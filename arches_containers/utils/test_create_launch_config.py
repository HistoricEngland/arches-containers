...
def test_create_launch_config_no_vscode_dir(mock_workspace, mock_os_path_exists, mock_os_makedirs, mock_open_file, mock_input):
    ...
    mock_workspace_instance.path = "/fake/workspace_a"
    mock_os_path_exists.side_effect = lambda path: path != "/fake/workspace_a/.vscode"
    ...
    # Assert
    mock_os_makedirs.assert_called_once_with("/fake/workspace_a/.vscode")
    mock_open_file.assert_called_once_with("/fake/workspace_a/.vscode/launch.json", "w")
...
def test_create_launch_config_launch_json_exists_no_override(mock_workspace, mock_os_path_exists, mock_input, mock_open_file):
    # Arrange
    mock_workspace_instance = mock_workspace.return_value
    mock_workspace_instance.path = "/fake/workspace_b"
    mock_os_path_exists.side_effect = lambda path: path in ["/fake/workspace_b/.vscode", "/fake/workspace_b/.vscode/launch.json"]
...
def test_create_launch_config_launch_json_exists_override(mock_workspace, mock_os_path_exists, mock_input, mock_open_file):
    # Arrange
    mock_workspace_instance = mock_workspace.return_value
    mock_workspace_instance.path = "/fake/workspace_c"
    mock_os_path_exists.side_effect = lambda path: path in ["/fake/workspace_c/.vscode", "/fake/workspace_c/.vscode/launch.json"]
    mock_input.return_value = 'y'
...
def test_create_launch_config_no_launch_json(mock_workspace, mock_os_path_exists, mock_os_makedirs, mock_open_file):
    ...
    # Assert
    mock_os_makedirs.assert_called_once_with("/fake/workspace1/.vscode")
    mock_open_file.assert_called_once_with("/fake/workspace1/.vscode/launch.json", "w")
    assert mock_open_file().write.call_count > 1
...
def test_create_launch_config_vscode_dir_exists(mock_workspace, mock_os_path_exists, mock_os_makedirs, mock_open_file, mock_input):
    mock_workspace_instance = mock_workspace.return_value
    mock_workspace_instance.path = "/fake/workspace2"

    # First scenario: only .vscode folder exists
    mock_os_path_exists.side_effect = lambda path: path == "/fake/workspace2/.vscode"
    ...
    create_launch_config()
    mock_open_file.assert_called_once_with("/fake/workspace2/.vscode/launch.json", "w")

    # Now pretend the launch.json also exists
    mock_workspace_instance.path = "/fake/workspace2"
    mock_os_path_exists.side_effect = lambda path: path in [
        "/fake/workspace2/.vscode",
        "/fake/workspace2/.vscode/launch.json",
    ]
